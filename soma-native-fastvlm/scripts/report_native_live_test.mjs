...
const outFile =
  getArg("--out") ||
  "/Users/zer00/Documents/VLM/soma-native-fastvlm/SOMA_NATIVE_LIVE_REPORT.md";
...
const lines = [];
lines.push("# SOMA Native Live Test Report");
lines.push("");
...
if (rawMediaFiles.length === 0) {
  lines.push("- PASS: no raw audio/video/image files found in SOMA storage.");
} else {
