...
from trace_hub.platform_audio import live_audio_status, resolve_audio_engine
from trace_hub.service import TraceHub
from trace_hub.stream_ingest import TranscriptStreamIngestor


class LiveAudioBridge:
    """Bridge a line-emitting ASR process into TRACE's extracted-memory pipeline."""

    def __init__(self, hub: TraceHub, provider: str = "continuous_audio_transcript") -> None:
        self.hub = hub
