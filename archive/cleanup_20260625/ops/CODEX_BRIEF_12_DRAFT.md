# CODEX BRIEF 12 (DRAFT) — trusted naming: gate hallucinations out of the world

Status: DRAFT for lead review. Supersedes the naming half of brief 11 once
approved. Fusion geometry (brief 11) stays; this brief fixes WHAT enters
the world, not WHERE it lands.
...
- Suite + north-star green after any trace_hub/ingest changes. No new GPU
