...
1. PERSISTENCE NEVER EXECUTES (fact: after a full session of use,
   `Library/Application Support/TRACE/spatial_world.json` DOES NOT EXIST
...
3. NO DIAGNOSTICS (fact: native log has zero spatial entries — failures
   ...
   `Application Support/TRACE/spatial_diag.ndjson`:
...
X-TRACE-Token; trace_hub.sqlite3; no Flask; -sdk iphoneos26.5 +
...
north-star stay green after any trace_hub change. Findings →
ops/HANDOVER.md.
