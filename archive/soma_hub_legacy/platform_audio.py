    ...
    profiles = [
        {
            ...
            "reason": "Pipe transcript lines into SOMA from any external ASR source.",
            "command": "python3 -m soma_hub stream-stdin --data-dir data",
        },
        {
            "engine": "tail-file",
            "supported": True,
            ...
            "command": "python3 -m soma_hub tail-file /tmp/soma-transcript.txt --data-dir data",
        },
    ]
