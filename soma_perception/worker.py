...
from soma_perception.colors import dominant_color_name
from soma_perception.memory import MemoryEmitter
from soma_perception.models import Detection, TrackState, utc_now_iso
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run SOMA detector/tracker perception worker.")
