...
- `PYTHONPYCACHEPREFIX=/tmp/soma_pycache python3 -m py_compile scripts/capture_index.py` PASS
...
does not change `soma_hub`, and the brief says to stop after P0.

## Scope Notes

- No `soma_hub` files changed.
