...
- Threaded trust through offline inventory, fusion, ingest, `/api/world`, `/world3d`, and spatial recall.
  ...
  - `soma_hub.graph` refuses rejected spatial words and filters legacy rejected poses from spatial recall.
...
- `PYTHONPYCACHEPREFIX=/tmp/soma_pycache python3 -m py_compile ...` PASS
