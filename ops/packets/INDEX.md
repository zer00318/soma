...
| P03 | [The Leash v1](P03-leash-v1.md) | guided | Opus medium | P02 ✓ | MERGED 2026-07-04: evaluation/leash.py (per-domain volume + real-agent answerability + refusal honesty + STARVED/THIN/FED verdict), leash_history.jsonl grows per run, THE YANK (--report exit-2 on 5 merges no move) unit-tested. Live smoke: 3 domains FED, 4 STARVED (digital/screen·motion·sound·temporal uncaptured — anti-tunnel signal live). 272 tests green |
